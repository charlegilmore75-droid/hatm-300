...
export const messages = {
  ar: {
    ...
    globalMarkup: 'هامش الربح العام',
    totalUsers: 'إجمالي المستخدمين',
    totalOrders: 'إجمالي الطلبات',
    totalProfit: 'إجمالي الأرباح',
    providerBalance: 'رصيد المزود',
    min: 'الحد الأدنى',
    max: 'الحد الأقصى',
    perThousand: 'لكل 1000',
    orderNow: 'اطلب الآن',
    refill: 'إعادة تعبئة',
    walletTopup: 'شحن المحفظة',
    history: 'السجل',
    creditAmount: 'المبلغ المُضاف',
